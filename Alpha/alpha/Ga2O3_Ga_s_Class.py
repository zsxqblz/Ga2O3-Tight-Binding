...
class Ga2O3_Ga_s_Class:
    def __init__(self, onsite, hopping, m, r):
        ...
        path = [[4/3,2/3,1],[0, 0, 0], [4/3,2/3,1], [
            0, 0, 0], [1, 0, 0], [4/3,2/3,1]]
        # labels of the nodes
        self.label = ( r'$H $',r'$\Gamma $', r'$H $', r'$\Gamma $', r'$M $', r'$H $')
        ...
        def findBMass(E, k_norm, start, end):
            ...
            """
            k_norm = np.multiply(k_norm, 1e10)  # 1/Ang to 1/m and add a 2pi

...
class Ga2O3_Ga_s_Class:
    ...
    def __init__(self, onsite, hopping):
        ...
        my_model.set_hop(hopping[520],8,16,[-1,-1,0])
        my_model.set_hop(hopping[521],9,17,[-1,-1,0])
        my_model.set_hop(hopping[522],10,18,[-1,-1,0])
        my_model.set_hop(hopping[523],11,19,[-1,-1,0])
        my_model.set_hop(hopping[524],4,16,[-1,-1,0])
        my_model.set_hop(hopping[525],5,17,[-1,-1,0])
        my_model.set_hop(hopping[526],6,18,[-1,-1,0])
        my_model.set_hop(hopping[527],7,19,[-1,-1,0])
        my_model.set_hop(hopping[528],12,16,[-1,-1,0])
        my_model.set_hop(hopping[529],13,17,[-1,-1,0])
        my_model.set_hop(hopping[530],14,18,[-1,-1,0])
        my_model.set_hop(hopping[531],15,19,[-1,-1,0])
        my_model.set_hop(hopping[532],14,19,[-1,0,0])
        my_model.set_hop(hopping[533],14,19,[0,1,0])
        my_model.set_hop(hopping[534],6,19,[-1,0,0])
        my_model.set_hop(hopping[535],6,19,[0,1,0])
        my_model.set_hop(hopping[536],10,19,[-1,0,0])
        my_model.set_hop(hopping[537],11,18,[0,-1,0])
        my_model.set_hop(hopping[538],10,19,[0,1,0])
        my_model.set_hop(hopping[539],11,18,[1,0,0])
        my_model.set_hop(hopping[540],7,18,[0,-1,0])
        my_model.set_hop(hopping[541],7,18,[1,0,0])
        my_model.set_hop(hopping[542],15,18,[0,-1,0])
        my_model.set_hop(hopping[543],15,18,[1,0,0])
        my_model.set_hop(hopping[544],6,16,[0,0,0])
        my_model.set_hop(hopping[545],12,18,[0,0,0])
        my_model.set_hop(hopping[546],8,18,[0,0,0])
        my_model.set_hop(hopping[547],10,16,[0,0,0])
        my_model.set_hop(hopping[548],14,16,[0,0,0])
        my_model.set_hop(hopping[549],4,18,[0,0,0])
        my_model.set_hop(hopping[550],5,19,[0,0,0])
        my_model.set_hop(hopping[551],15,17,[0,0,0])
        my_model.set_hop(hopping[552],9,19,[0,0,0])
        my_model.set_hop(hopping[553],11,17,[0,0,0])
        my_model.set_hop(hopping[554],13,19,[0,0,0])
        my_model.set_hop(hopping[555],7,17,[0,0,0])
        my_model.set_hop(hopping[556],13,18,[0,-1,-1])
        my_model.set_hop(hopping[557],13,18,[1,0,-1])
        my_model.set_hop(hopping[558],10,17,[-1,0,1])
        my_model.set_hop(hopping[559],9,18,[0,-1,-1])
        my_model.set_hop(hopping[560],5,18,[0,-1,-1])
        my_model.set_hop(hopping[561],5,18,[1,0,-1])
        my_model.set_hop(hopping[562],6,17,[-1,0,1])
        my_model.set_hop(hopping[563],6,17,[0,1,1])
        my_model.set_hop(hopping[564],10,17,[0,1,1])
        my_model.set_hop(hopping[565],9,18,[1,0,-1])
        my_model.set_hop(hopping[566],14,17,[-1,0,1])
        my_model.set_hop(hopping[567],14,17,[0,1,1])
        my_model.set_hop(hopping[568],15,16,[0,-1,-1])
        my_model.set_hop(hopping[569],15,16,[1,0,-1])
        my_model.set_hop(hopping[570],8,19,[-1,0,1])
        my_model.set_hop(hopping[571],11,16,[0,-1,-1])
        my_model.set_hop(hopping[572],7,16,[0,-1,-1])
        my_model.set_hop(hopping[573],7,16,[1,0,-1])
        my_model.set_hop(hopping[574],4,19,[-1,0,1])
        my_model.set_hop(hopping[575],4,19,[0,1,1])
        my_model.set_hop(hopping[576],8,19,[0,1,1])
        my_model.set_hop(hopping[577],11,16,[1,0,-1])
        my_model.set_hop(hopping[578],12,19,[-1,0,1])
        my_model.set_hop(hopping[579],12,19,[0,1,1])
        my_model.set_hop(hopping[580],7,17,[-1,0,0])
        my_model.set_hop(hopping[581],7,17,[0,1,0])
        my_model.set_hop(hopping[582],11,17,[-1,0,0])
        my_model.set_hop(hopping[583],9,19,[0,-1,0])
        my_model.set_hop(hopping[584],15,17,[-1,0,0])
        my_model.set_hop(hopping[585],15,17,[0,1,0])
        my_model.set_hop(hopping[586],13,19,[0,-1,0])
        my_model.set_hop(hopping[587],13,19,[1,0,0])
        my_model.set_hop(hopping[588],11,17,[0,1,0])
        my_model.set_hop(hopping[589],9,19,[1,0,0])
        my_model.set_hop(hopping[590],5,19,[0,-1,0])
        my_model.set_hop(hopping[591],5,19,[1,0,0])
        my_model.set_hop(hopping[592],4,18,[-1,0,0])
        my_model.set_hop(hopping[593],4,18,[0,1,0])
        my_model.set_hop(hopping[594],8,18,[-1,0,0])
        my_model.set_hop(hopping[595],10,16,[0,-1,0])
        my_model.set_hop(hopping[596],12,18,[-1,0,0])
        my_model.set_hop(hopping[597],12,18,[0,1,0])
        my_model.set_hop(hopping[598],14,16,[0,-1,0])
        my_model.set_hop(hopping[599],14,16,[1,0,0])
        my_model.set_hop(hopping[600],8,18,[0,1,0])
        my_model.set_hop(hopping[601],10,16,[1,0,0])
        my_model.set_hop(hopping[602],6,16,[0,-1,0])
        my_model.set_hop(hopping[603],6,16,[1,0,0])
        my_model.set_hop(hopping[604],14,17,[-1,0,0])
        my_model.set_hop(hopping[605],14,17,[0,1,0])
        my_model.set_hop(hopping[606],12,19,[-1,0,0])
        my_model.set_hop(hopping[607],12,19,[0,1,0])
        my_model.set_hop(hopping[608],8,19,[-1,0,0])
        my_model.set_hop(hopping[609],10,17,[-1,0,0])
        my_model.set_hop(hopping[610],9,18,[0,-1,0])
        my_model.set_hop(hopping[611],11,16,[0,-1,0])
        my_model.set_hop(hopping[612],5,18,[0,-1,0])
        my_model.set_hop(hopping[613],7,16,[0,-1,0])
        my_model.set_hop(hopping[614],5,18,[1,0,0])
        my_model.set_hop(hopping[615],7,16,[1,0,0])
        my_model.set_hop(hopping[616],4,19,[-1,0,0])
        my_model.set_hop(hopping[617],6,17,[-1,0,0])
        my_model.set_hop(hopping[618],4,19,[0,1,0])
        my_model.set_hop(hopping[619],6,17,[0,1,0])
        my_model.set_hop(hopping[620],8,19,[0,1,0])
        my_model.set_hop(hopping[621],10,17,[0,1,0])
        my_model.set_hop(hopping[622],9,18,[1,0,0])
        my_model.set_hop(hopping[623],11,16,[1,0,0])
        my_model.set_hop(hopping[624],15,16,[0,-1,0])
        my_model.set_hop(hopping[625],15,16,[1,0,0])
        my_model.set_hop(hopping[626],13,18,[0,-1,0])
        my_model.set_hop(hopping[627],13,18,[1,0,0])
        my_model.set_hop(hopping[628],12,17,[-1,1,0])
        my_model.set_hop(hopping[629],4,17,[-1,1,0])
        my_model.set_hop(hopping[630],8,17,[-1,1,0])
        my_model.set_hop(hopping[631],9,16,[1,-1,0])
        my_model.set_hop(hopping[632],5,16,[1,-1,0])
        my_model.set_hop(hopping[633],13,16,[1,-1,0])
        my_model.set_hop(hopping[634],4,17,[-1,1,1])
        my_model.set_hop(hopping[635],13,16,[1,-1,-1])
        my_model.set_hop(hopping[636],8,17,[-1,1,1])
        my_model.set_hop(hopping[637],9,16,[1,-1,-1])
        my_model.set_hop(hopping[638],12,17,[-1,1,1])
        my_model.set_hop(hopping[639],5,16,[1,-1,-1])
        my_model.set_hop(hopping[640],5,16,[0,-1,-1])
        my_model.set_hop(hopping[641],5,16,[1,0,-1])
        my_model.set_hop(hopping[642],13,16,[0,-1,-1])
        my_model.set_hop(hopping[643],13,16,[1,0,-1])
        my_model.set_hop(hopping[644],8,17,[-1,0,1])
        my_model.set_hop(hopping[645],9,16,[0,-1,-1])
        my_model.set_hop(hopping[646],8,17,[0,1,1])
        my_model.set_hop(hopping[647],9,16,[1,0,-1])
        my_model.set_hop(hopping[648],12,17,[-1,0,1])
        my_model.set_hop(hopping[649],12,17,[0,1,1])
        my_model.set_hop(hopping[650],4,17,[-1,0,1])
        my_model.set_hop(hopping[651],4,17,[0,1,1])
        my_model.set_hop(hopping[652],5,19,[-1,-1,0])
        my_model.set_hop(hopping[653],6,16,[-1,-1,0])
        my_model.set_hop(hopping[654],8,18,[-1,-1,0])
        my_model.set_hop(hopping[655],9,19,[-1,-1,0])
        my_model.set_hop(hopping[656],10,16,[-1,-1,0])
        my_model.set_hop(hopping[657],11,17,[-1,-1,0])
        my_model.set_hop(hopping[658],15,17,[-1,-1,0])
        my_model.set_hop(hopping[659],12,18,[-1,-1,0])
        my_model.set_hop(hopping[660],14,16,[-1,-1,0])
        my_model.set_hop(hopping[661],13,19,[-1,-1,0])
        my_model.set_hop(hopping[662],4,18,[-1,-1,0])
        my_model.set_hop(hopping[663],7,17,[-1,-1,0])
        my_model.set_hop(hopping[664],15,18,[0,0,-1])
        my_model.set_hop(hopping[665],7,18,[0,0,-1])
        my_model.set_hop(hopping[666],11,18,[0,0,-1])
        my_model.set_hop(hopping[667],10,19,[0,0,1])
        my_model.set_hop(hopping[668],6,19,[0,0,1])
        my_model.set_hop(hopping[669],14,19,[0,0,1])
        my_model.set_hop(hopping[670],12,17,[-2,0,0])
        my_model.set_hop(hopping[671],12,17,[0,2,0])
        my_model.set_hop(hopping[672],8,17,[-2,0,0])
        my_model.set_hop(hopping[673],9,16,[0,-2,0])
        my_model.set_hop(hopping[674],4,17,[-2,0,0])
        my_model.set_hop(hopping[675],4,17,[0,2,0])
        my_model.set_hop(hopping[676],5,16,[0,-2,0])
        my_model.set_hop(hopping[677],5,16,[2,0,0])
        my_model.set_hop(hopping[678],8,17,[0,2,0])
        my_model.set_hop(hopping[679],9,16,[2,0,0])
        my_model.set_hop(hopping[680],13,16,[0,-2,0])
        my_model.set_hop(hopping[681],13,16,[2,0,0])
        my_model.set_hop(hopping[682],8,17,[-2,0,1])
        my_model.set_hop(hopping[683],9,16,[0,-2,-1])
        my_model.set_hop(hopping[684],4,17,[-2,0,1])
        my_model.set_hop(hopping[685],4,17,[0,2,1])
        my_model.set_hop(hopping[686],13,16,[0,-2,-1])
        my_model.set_hop(hopping[687],13,16,[2,0,-1])
        my_model.set_hop(hopping[688],12,17,[-2,0,1])
        my_model.set_hop(hopping[689],12,17,[0,2,1])
        my_model.set_hop(hopping[690],5,16,[0,-2,-1])
        my_model.set_hop(hopping[691],5,16,[2,0,-1])
        my_model.set_hop(hopping[692],8,17,[0,2,1])
        my_model.set_hop(hopping[693],9,16,[2,0,-1])
        my_model.set_hop(hopping[694],7,18,[0,0,0])
        my_model.set_hop(hopping[695],14,19,[0,0,0])
        my_model.set_hop(hopping[696],10,19,[0,0,0])
        my_model.set_hop(hopping[697],11,18,[0,0,0])
        my_model.set_hop(hopping[698],15,18,[0,0,0])
        my_model.set_hop(hopping[699],6,19,[0,0,0])
        my_model.set_hop(hopping[700],15,18,[0,-1,-1])
        my_model.set_hop(hopping[701],15,18,[1,0,-1])
        my_model.set_hop(hopping[702],6,19,[-1,0,1])
        my_model.set_hop(hopping[703],6,19,[0,1,1])
        my_model.set_hop(hopping[704],10,19,[-1,0,1])
        my_model.set_hop(hopping[705],11,18,[0,-1,-1])
        my_model.set_hop(hopping[706],10,19,[0,1,1])
        my_model.set_hop(hopping[707],11,18,[1,0,-1])
        my_model.set_hop(hopping[708],7,18,[0,-1,-1])
        my_model.set_hop(hopping[709],7,18,[1,0,-1])
        my_model.set_hop(hopping[710],14,19,[-1,0,1])
        my_model.set_hop(hopping[711],14,19,[0,1,1])
        #endregion

...
class Ga2O3_Ga_s_Class:
    def __init__(self, onsite, hopping, m1, r1, m2, r2):
        ...
        my_model.set_hop(hopping[17],2,3,[-2,-2,0])
        my_model.set_hop(hopping[18],0,3,[0,-1,0])
        my_model.set_hop(hopping[19],1,2,[0,1,0])
        my_model.set_hop(hopping[20],1,2,[-1,-1,1])
        my_model.set_hop(hopping[21],0,2,[-1,-2,0])
        my_model.set_hop(hopping[22],1,2,[-1,-1,0])
        my_model.set_hop(hopping[23],2,3,[-2,-1,-1])
        my_model.set_hop(hopping[24],2,3,[0,1,-1])
        my_model.set_hop(hopping[25],2,3,[-2,-1,0])
        my_model.set_hop(hopping[26],2,3,[0,1,0])
        my_model.set_hop(hopping[27],0,0,[0,0,-1])
        my_model.set_hop(hopping[28],1,1,[0,0,-1])
        my_model.set_hop(hopping[29],2,2,[0,0,-1])
        my_model.set_hop(hopping[30],3,3,[0,0,-1])
        my_model.set_hop(hopping[31],0,1,[-1,-1,0])
        my_model.set_hop(hopping[32],2,3,[0,0,0])
        my_model.set_hop(hopping[33],1,3,[0,0,0])
        my_model.set_hop(hopping[34],0,2,[0,0,0])
        my_model.set_hop(hopping[35],0,3,[-1,-1,-1])
        my_model.set_hop(hopping[36],0,3,[0,0,-1])
        my_model.set_hop(hopping[37],1,2,[0,0,1])
        my_model.set_hop(hopping[38],1,2,[1,1,1])
        my_model.set_hop(hopping[39],0,2,[1,0,0])
        my_model.set_hop(hopping[40],1,3,[0,1,0])
        my_model.set_hop(hopping[41],1,2,[0,0,0])
        my_model.set_hop(hopping[42],0,3,[-1,-1,0])
        my_model.set_hop(hopping[43],0,3,[0,0,0])
        my_model.set_hop(hopping[44],0,1,[0,-1,-1])
        my_model.set_hop(hopping[45],1,3,[-1,-1,0])
        my_model.set_hop(hopping[46],2,3,[-1,0,-1])
        my_model.set_hop(hopping[47],0,1,[-1,-2,-1])
        my_model.set_hop(hopping[48],0,2,[0,0,-1])
        my_model.set_hop(hopping[49],1,3,[0,0,1])
        my_model.set_hop(hopping[50],0,3,[-2,-2,-1])
        my_model.set_hop(hopping[51],0,3,[1,1,-1])
        my_model.set_hop(hopping[52],1,2,[2,2,1])
        my_model.set_hop(hopping[53],0,2,[2,1,0])
        my_model.set_hop(hopping[54],1,3,[-2,-1,0])
        my_model.set_hop(hopping[55],1,3,[1,2,0])
        my_model.set_hop(hopping[56],1,2,[2,2,0])
        my_model.set_hop(hopping[57],0,3,[-2,-2,0])
        my_model.set_hop(hopping[58],0,1,[0,0,0])

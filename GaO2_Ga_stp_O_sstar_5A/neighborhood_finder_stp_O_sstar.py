...
start_cell.append(site(orb[4], [0, 0, 0], 'st', 1))
start_cell.append(site(orb[5], [0, 0, 0], 'st', 2))
start_cell.append(site(orb[6], [0, 0, 0], 'st', 3))
start_cell.append(site(orb[7], [0, 0, 0], 'st', 4))
start_cell.append(site(orb[8], [0, 0, 0], 'st', 5))
start_cell.append(site(orb[9], [0, 0, 0], 'st', 6))
...
for x in range(-trans_range, trans_range+1):
    for y in range(-trans_range, trans_range+1):
        for z in range(-trans_range, trans_range+1):
            ...
            target_cell.append(site(orb[4], [x, y, z], 'st', 1))
            target_cell.append(site(orb[5], [x, y, z], 'st', 2))
            target_cell.append(site(orb[6], [x, y, z], 'st', 3))
            target_cell.append(site(orb[7], [x, y, z], 'st', 4))
            target_cell.append(site(orb[8], [x, y, z], 'st', 5))
            target_cell.append(site(orb[9], [x, y, z], 'st', 6))

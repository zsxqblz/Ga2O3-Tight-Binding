...
class Ga2O3_Ga_s_Class:
    def __init__(self, onsite, hopping, m, r):
        ...
        my_model.set_hop(hopping[34],2,3,[-2,-1,0])
        my_model.set_hop(hopping[35],2,3,[1,2,0])
        my_model.set_hop(hopping[36],1,3,[0,0,-1])
        my_model.set_hop(hopping[37],0,2,[0,0,1])
        my_model.set_hop(hopping[38],1,2,[1,-1,0])
        my_model.set_hop(hopping[39],0,3,[-1,1,0])
        my_model.set_hop(hopping[40],1,2,[-1,-2,-1])
        my_model.set_hop(hopping[41],1,2,[2,1,-1])
        my_model.set_hop(hopping[42],0,3,[-2,-1,1])
        my_model.set_hop(hopping[43],0,3,[1,2,1])
        my_model.set_hop(hopping[44],1,3,[-1,-2,0])
        my_model.set_hop(hopping[45],1,3,[2,1,0])
        my_model.set_hop(hopping[46],0,2,[-2,-1,0])
        my_model.set_hop(hopping[47],0,2,[1,2,0])
        my_model.set_hop(hopping[48],0,3,[-2,-1,0])
        my_model.set_hop(hopping[49],1,2,[-1,-2,0])
        my_model.set_hop(hopping[50],0,3,[1,2,0])
        my_model.set_hop(hopping[51],1,2,[2,1,0])
        my_model.set_hop(hopping[52],2,3,[-1,-1,1])
        my_model.set_hop(hopping[53],2,3,[1,1,1])
        my_model.set_hop(hopping[54],2,3,[-1,-1,0])
        my_model.set_hop(hopping[55],0,0,[0,0,-1])
        my_model.set_hop(hopping[56],1,1,[0,0,-1])
        my_model.set_hop(hopping[57],2,2,[0,0,-1])
        my_model.set_hop(hopping[58],3,3,[0,0,-1])
        my_model.set_hop(hopping[59],0,1,[-1,0,0])
        my_model.set_hop(hopping[60],0,1,[0,1,0])
